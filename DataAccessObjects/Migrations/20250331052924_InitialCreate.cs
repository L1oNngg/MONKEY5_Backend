    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("30000000-0000-0000-0000-000000000001"), new DateTime(1990, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "admin@monkey5.com", "Admin User", "Male", "123456789", "mKP10AxW/p5XFI+wYlNXUw==.J0HfhIYLOKl0Z4c0aSex7daDAXecvn74Jt5U6StKgWY=", "0123456789", "Manager" },
                    { new Guid("40000000-0000-0000-0000-000000000001"), new DateTime(1985, 5, 15, 0, 0, 0, 0, DateTimeKind.Utc), "nguyenvana@example.com", "Nguyen Van A", "Male", "123456789012", "znClThiLuErN9wNXXrO0Xg==.Fbrkptcw5GkZiXPlgeycaYF685FdTSu32yioTFEMYPQ=", "0123456781", "Customer" },
                    { new Guid("40000000-0000-0000-0000-000000000002"), new DateTime(1990, 8, 20, 0, 0, 0, 0, DateTimeKind.Utc), "tranthib@example.com", "Tran Thi B", "Female", "234567890123", "JX1NxMbHd88mmbyDQBDeEg==.n83jBM3E3svFG0fVO4JrKYGsFC5flZXCWuwqkklnh98=", "0123456782", "Customer" },
                    { new Guid("40000000-0000-0000-0000-000000000003"), new DateTime(1988, 3, 10, 0, 0, 0, 0, DateTimeKind.Utc), "levanc@example.com", "Le Van C", "Male", "345678901234", "hH8ZymGKb1YLvQsdOcH/iw==.hBxvRyZoInq5MO1QssbpvGI6IbrfiM5KTRovoaMLlCs=", "0123456783", "Customer" },
                    { new Guid("50000000-0000-0000-0000-000000000001"), new DateTime(1992, 4, 25, 0, 0, 0, 0, DateTimeKind.Utc), "phamthid@example.com", "Pham Thi D", "Female", "456789012345", "PDGtReUmc2o3OZicBhB+ag==.sAaa4bkUnyTQqP+2wLjhDU2ebkgbFvgE02Yld2iFGT8=", "0234567891", "Staff" },
                    { new Guid("50000000-0000-0000-0000-000000000002"), new DateTime(1991, 7, 15, 0, 0, 0, 0, DateTimeKind.Utc), "hoangvane@example.com", "Hoang Van E", "Male", "567890123456", "jtkSn+46MtsSky2pRJhedw==.68P2UECpKa67b9gsbG2xCvxh1emgbWqPSEVSX2EXoTQ=", "0234567892", "Staff" },
                    { new Guid("50000000-0000-0000-0000-000000000003"), new DateTime(1989, 9, 5, 0, 0, 0, 0, DateTimeKind.Utc), "nguyenthif@example.com", "Nguyen Thi F", "Female", "678901234567", "do3/8hGKWaGV77Dw+75TlQ==.JV2bd4HImEmEUCT1UrtDQlpZIqsh78Y6ttjYtzg2uX8=", "0234567893", "Staff" },
                    { new Guid("50000000-0000-0000-0000-000000000004"), new DateTime(1993, 2, 18, 0, 0, 0, 0, DateTimeKind.Utc), "tranvang@example.com", "Tran Van G", "Male", "789012345678", "7ApGcLOFakLzoayl1DD49g==.zKiz2kBHdFMyytWBPMHcV8rTOumDH4z9cuze/fDC1Nk=", "0234567894", "Staff" },
                    { new Guid("50000000-0000-0000-0000-000000000005"), new DateTime(1987, 11, 30, 0, 0, 0, 0, DateTimeKind.Utc), "lethih@example.com", "Le Thi H", "Female", "890123456789", "EUPCB2Sd7P1YXvfHOe+B0g==.+kZiZzIbdvO521fP2D8lGLMm1XZWPoEal2U2d3r+kKQ=", "0234567895", "Staff" },
                    { new Guid("50000000-0000-0000-0000-000000000006"), new DateTime(1990, 6, 12, 0, 0, 0, 0, DateTimeKind.Utc), "phamvani@example.com", "Pham Van I", "Male", "901234567890", "bbX7sJhVeBxMCq/yvLvGGA==.+E7NDN1oE31DlAx97zZV4q6yVXCOCvseXV2vsSPKiSk=", "0234567896", "Staff" }
                });
